...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent(
            ...
            # sending text to the port of the server 135
            netcat.py -t 192.168.1.108 -p 5555 # connecting to the server
            '''
        )
    )
...
# Example 1:
    # For Server: python ./Sources/netcat.py -t 172.31.239.69 -p 9994 -l -c
    # For Client: python ./Sources/netcat.py -t 172.31.239.69 -p 9994

# Example 2:
    # For Server: python ./Sources/netcat.py -t 172.31.239.69 -p 9994 -l -e 'cat /etc/passwd'
    # For Client: python ./Sources/netcat.py -t 172.31.239.69 -p 9994
```
